# apmia_php_ext_volume 1.0-2 by J. Mertin -- joerg.mertin@broadcom.com
...
```
  ...
  apmia-php-vol:
    ...
    volumes:
      - /opt/apmia
```
_**NOTE**: The volumes "/opt/apmia" is very important if one wants to use the same image for deploying the probes. See next chapter_
